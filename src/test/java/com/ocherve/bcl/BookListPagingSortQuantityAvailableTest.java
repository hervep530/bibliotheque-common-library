 ...
 *
 */
class BookListPagingSortQuantityAvailableTest {
	...
	void given_AscAttributeValue_When_gettingParametersOrCategory_Then_returnValidAttributeOrParameters() {
		...
		assertEquals(paging.toUrlParameters(), "sort_by_quantity_available=ASC");
	}
	...
	void given_DescLowerAttributeValue_When_gettingParametersOrCategory_Then_returnValidAttributeOrParameters() {
		...
		assertEquals(paging.getSortByQuantityAvailable(), "DESC");
		assertEquals(paging.toUrlParameters(), "sort_by_quantity_available=DESC");
	}
