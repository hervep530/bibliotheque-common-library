...
/**
 * Testing SortById feature
 * 
 * @author herve_dev
 */
class BookListPagingSortIdTest {
	...
	void given_AscAttributeValue_When_gettingParametersOrCategory_Then_returnValidAttributeOrParameters() {
		...
		assertEquals(paging.toUrlParameters(), "sort_by_id=ASC");
	}
	...
	void given_DescLowerAttributeValue_When_gettingParametersOrCategory_Then_returnValidAttributeOrParameters() {
		...
		assertEquals(paging.getSortById(), "DESC");
		assertEquals(paging.toUrlParameters(), "sort_by_id=DESC");
	}
