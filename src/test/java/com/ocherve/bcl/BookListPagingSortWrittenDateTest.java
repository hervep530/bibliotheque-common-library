 ...
 *
 */
class BookListPagingSortWrittenDateTest {
	...
	void given_AscAttributeValue_When_gettingParametersOrCategory_Then_returnValidAttributeOrParameters() {
		...
		assertEquals(paging.toUrlParameters(), "sort_by_written_date=ASC");
	}
	...
	void given_DescLowerAttributeValue_When_gettingParametersOrCategory_Then_returnValidAttributeOrParameters() {
		...
		assertEquals(paging.getSortByWrittenDate(), "DESC");
		assertEquals(paging.toUrlParameters(), "sort_by_written_date=DESC");
	}
