 ...
 *
 */
class BookListFilterWriterTest {
	...
	void given_OutOfRangeAttributeValue_When_instanciatingFilter_Then_ThrowFilterException() {
		assertThrows(BookFilterException.class,
                		() -> new FilterTest("",
        				"999999999999999999999999999999999999999999999999999999999999999999911111111111199999999",
        				"","","","","","","","","","","","","","","","")
                	);
	}
	...
	void given_relevantAttributeValue_When_gettingParametersOrCategory_Then_returnValidAttributeOrParameters() {
		FilterTest filter = new FilterTest("","56","","","","","","","","","","","","","","","","");
		assertEquals(filter.getWriterId(), "56");
		assertEquals(filter.toUrlParameters(), "writer_id=56");
	}
